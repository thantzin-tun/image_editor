...
class _ImagePickerWidgetState extends State<ImagePickerWidget> {
  ...
  DrawingShapeController drawingShapeController = DrawingShapeController();    

  int selectedIndex = -1; //Whole Buttom Navigation Blue Color Animation
                    ...
                    children: <Widget>[
                      AnimatedContainer(
                        ...
                        child: IconButton(
                          tooltip: "Undo",
                          onPressed: () {
                            imagePickerController.offsets.removeLast();
                          },
                          icon: const Icon(
                            Icons.undo_outlined,
                            color: defaultWhiteColor,
                      ...
                      for(var i = 0; i < shapeIconList.length; i ++)
                          ...
                          onPressed: () {
                              drawingShapeController.drawShapeCircle();
                          },
                          icon: Icon(
                            shapeIconList[i],
                            color: iconGradientColor,
                        ...
                        child: IconButton(
                            ...
                            onPressed: () {
                              if (imagePickerController
                                ...
                                // Get.to(ImageEditorWithText(
                                //     imageFile: imagePickerController.imageFile
                                //         .value)); //This is screen Widget
                              }
                            },
                            icon: Icon(Icons.text_fields,
                                size: selectedIndex == 1 ? 28 : 20,
                                color: selectedIndex == 1
                                    ? Colors.white
                                    : Colors.black))),
                    ...
                    AnimatedContainer(
                        ...
                        child: IconButton(
                            ...
                            onPressed: () {
                              if (imagePickerController
                                  .imageFile.value.path.isNotEmpty) {
                                imagePickerController.isPaintChange(true);
                                setState(() {
                                  selectedIndex = 2;
                                  isEditText = false;
                                });
                                  ...
                                  builder: (context) {
                                    return AlertDialog(
                                      ...
                                      content: SingleChildScrollView(
                                        child: Obx(
                                          () => ColorPicker(
                                            pickerColor: imagePickerController
                                                .initialColor.value,
                                            enableAlpha: false,
                                            pickerAreaHeightPercent: 0.8,
                                            onColorChanged: (color) {
                                              imagePickerController
                                                  .initialColorChange(color);
                                            },
                                          ),
                                        ),
                                      ),
                                ...
                                showDialog<void>(
                                  ...
                                  builder: (context) {
                                    return MyAlertDialogBox(
                                      ...
                                      primaryFunction: () {
                                        imagePickerController
                                            .drawingImageScreenShot(pixelRatio,"save");
                                        Navigator.of(context).pop();
                                      },
                                      secondaryButtonText: "Temporily",
                                      secondaryFunction: () {
                                          imagePickerController.drawingImageScreenShot(pixelRatio, "tempo");
                                          Navigator.of(context).pop();
                                      },
                                    );
                                  },
                                  ...
                                  builder: (context) {
                                    return MyAlertDialogBox(
                                      ...
                                      primaryFunction: () {
                                        imagePickerController.imageFile.value =
                                            File("");
                                        imagePickerController.offsets.value =
                                            <Offset>[];
                                        imagePickerController
                                            .isPaintChange(false);
                                        setState(() {
